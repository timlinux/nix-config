...
sudo ln -s /root/nix-config/hosts/amy/configuration.nix /etc/nixos/configuration.nix
sudo ln -s /root/nix-config/hosts/amy/hardware-configuration.nix /etc/nixos/hardware-configuration.nix
